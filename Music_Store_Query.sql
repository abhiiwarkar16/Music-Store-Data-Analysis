...
-- Step 1: Calculate total spending for each customer in each country
...
-- Step 2: Determine the maximum spending amount for each country
...
-- Step 3: Join to get customers with the maximum spending per country
SELECT 
    cc.billing_country, 
    cc.total_spending, 
    cc.first_name, 
